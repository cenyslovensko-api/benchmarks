...
Create a fine-grained PAT (or classic PAT with `repo` scope) with **Contents: Read and write** on this repository. Store
it as a secret (e.g. `BENCHMARKS_REPO_TOKEN`) in the calling repository.
...
| Secret  | Description                              |
|---------|------------------------------------------|
| `token` | PAT with write access to this repository |
